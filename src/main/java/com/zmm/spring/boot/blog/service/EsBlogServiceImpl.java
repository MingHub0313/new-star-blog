...
import com.zmm.spring.boot.blog.repository.es.EsBlogRepository;
import com.zmm.spring.boot.blog.vo.TagVO;


/**
 * @author 1805783671
 * @version EsBlogServiceImpl-1.0
 * @time 2019年1月7日 下午7:32:20
 * @Desc 描述 EsBlog 服务.
 */
@Service
...
//		}
		...
		List<Bucket> modelBucketIt =  modelTerms.getBuckets();
		for (Bucket actiontypeBucket : modelBucketIt) {
